...
```sh
java -jar build-gradle/libs/resforge-1.3.0.jar          # opens the editor
java -jar build-gradle/libs/resforge-1.3.0.jar gui horse.res   # opens a file
```
...
```sh
RESFORGE_UI_SCALE=1.25 java -jar build-gradle/libs/resforge-1.3.0.jar
java -Dresforge.uiScale=1.25 -jar build-gradle/libs/resforge-1.3.0.jar
```
...
./gradlew jar        # -> build-gradle/libs/resforge-1.3.0.jar
```
...
mvn package          # compile + run the tests + build the jar
                     # -> build-maven/resforge-1.3.0.jar
```
...
ant jar              # -> build-ant/libs/resforge-1.3.0.jar
```
...
```sh
./gradlew jar
# the jar is at build-gradle/libs/resforge-1.3.0.jar
alias resforge='java -jar build-gradle/libs/resforge-1.3.0.jar'
```
